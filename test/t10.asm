...
..@l6:
	...
	mov	edx, [ebp - 200]	; J_ge_&17
	sub	ecx, edx
	mov	[ebp - 196], ecx	; J_ge_&16
	xor	edx, edx
	mov	eax, [ebp - 168]	; J_ge_&9
	mov	ecx, [ebp - 196]	; J_ge_&16
	div	ecx
	mov	[ebp - 188], eax	; J_ge_&14
	...
	mov	ecx, [ebp - 204]	; J_ge_&18
	mov	edx, [ebp - 216]	; J_ge_&21
	add	ecx, edx
	...
	mov	ecx, [ebp - 212]	; J_ge_&20
	mov	edx, [ebp - 224]	; J_ge_&23
	sub	ecx, edx
	mov	[ebp - 220], ecx	; J_ge_&22
	mov	ecx, [ebp - 220]	; J_ge_&22
	mov	edx, 1
	add	ecx, edx
